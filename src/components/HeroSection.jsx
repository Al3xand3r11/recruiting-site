    ...
    return (
        <div className='bg-hero-image w-full h-screen bg-cover bg-center content-center'>
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 pt-128">
                <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl ">Progressive Minded Recruiting</h1>
                <p className="mb-8 text-lg font-large lg:text-xl sm:px-16 xl:px-48 ">Partner With an Agency that Understands Your Needs</p>
